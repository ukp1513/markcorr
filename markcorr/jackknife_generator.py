...
def make_JK_samples(real_table, rand_table, njacks_ra, njacks_dec, realracol, realdeccol, randracol, randdeccol, plot=False):
...
def give_JK_sample(sample_nr, real_tab, rand_tab, njacks_ra=1, njacks_dec=30, realracol='RA',realdeccol='DEC',randracol='RA', randdeccol='Dec', equalArea=True, maskFile=None):
